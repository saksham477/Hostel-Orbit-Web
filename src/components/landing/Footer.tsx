      ...
      <div className="section-container py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            ...
            <p className="text-background/60 text-body-sm mb-8 max-w-xs leading-relaxed">
              Smarter hostel management. Happier students. The all-in-one app for modern hostels across India.
            </p>
