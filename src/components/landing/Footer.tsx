        ...
        <div className="flex justify-center gap-10">
          <div>
            <a href="#" className="flex items-center justify-center gap-3 mb-6 group">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg group-hover:shadow-primary/30 transition-shadow duration-300">
                <Orbit className="w-6 h-6 text-primary-foreground" />
              </div>
              <span className="font-bold text-xl tracking-tight">Hostel Orbit</span>
            </a>
            <p className="text-background/60 text-body-sm mb-8 max-w-xs leading-relaxed text-center">
              Smarter hostel management. Happier students. The all-in-one app for modern hostels across Nepal.
            </p>
          </div>
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-sm">hello@hostelorbit.app</span>
              </a>
              <a
...
<div className="flex items-center gap-3">
          ...
          {/* Product links */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-background/80">Product</h4>
          ...
          {/* Company links */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-background/80">Company</h4>
            <ul className="space-y-4">
          ...
          {/* Legal links */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-background/80">Legal</h4>
            <ul className="space-y-4">
        ...
        <div className="border-t border-background/10 mt-16 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <a href="https://bleedingtech.com.np" target="_blank" rel="noopener noreferrer">
            <p className="text-background/40 text-sm">
              Design and Developed by <span className="text-primary">Bleeding Tech Pvt. Ltd.</span>
            </p>
          </a> 
        </div>
      </div>
